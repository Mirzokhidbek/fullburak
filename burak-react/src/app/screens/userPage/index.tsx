      ...
      <Container maxWidth="lg">
        ...
        <Grid container spacing={4}>
          <Grid size={{ xs: 12, md: 6 }}>
            <Card sx={{ p: 3.5, borderRadius: 4, height: "100%" }}>
              ...
              <Grid container spacing={2.5}>
                <Grid size={{ xs: 12 }}>
                  <TextField fullWidth label="Full Name" defaultValue="Miro Developer" size="small" />
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <TextField fullWidth label="Email Address" defaultValue="mirodeveloper7@gmail.com" size="small" />
                </Grid>
                <Grid size={{ xs: 12 }}>
                  <TextField fullWidth label="Phone Number" defaultValue="+998 90 808 08 07" size="small" />
                </Grid>
                <Grid size={{ xs: 12 }}>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                <Box sx={{ p: 2, bgcolor: "#f8fafc", borderRadius: 3, border: "1.5px solid #f59e0b" }}>
                  <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                    ...
                    <Chip label="DEFAULT" size="small" color="primary" sx={{ fontSize: "0.68rem", height: 20 }} />
                  </Box>
